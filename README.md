...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/monero-laravel.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/monero-laravel)
...
```bash
php artisan vendor:publish --tag="monero-laravel-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="monero-laravel-views"
```

## Usage

```php
$moneroLaravel = new Rbaskam\MoneroLaravel();
echo $moneroLaravel->echoPhrase('Hello, Rbaskam!');
```
